...
impl Ticket {
    pub fn new(title: String, description: String, status: String) -> Ticket {
        if Ticket::is_valid_title(&title) {
        }
        if Ticket::is_valid_description(&description) {
        }
        if Ticket::is_valid_status(&status) {
        }
    ...
    fn is_valid_description(description: &String) -> bool {
