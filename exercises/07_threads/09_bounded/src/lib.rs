...
impl TicketStoreClient {
    pub fn insert(&self, draft: TicketDraft) -> Result<TicketId, ()> {
        let (response_channel, response_receiver) = std::sync::mpsc::sync_channel::<TicketId>(self.capacity);
    ...
    pub fn get(&self, id: TicketId) -> Result<Option<Ticket>, ()> {
        let (response_channel, response_receiver) = std::sync::mpsc::sync_channel::<Option<Ticket>>(self.capacity);
